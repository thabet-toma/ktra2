...
| `core` | طبقة مشتركة: عزل الشركة، الصلاحيات، التقارير، الوحدات المرخّصة، الداشبورد، المساعد الذكي | 17,500 | 10,300 | `/api/` (متفرّق) |
...
| `employee_ops` | متابعة الموظفين: المهامّ والنقاط والتوظيف — **وحدة مرخّصة، معزولة** | 3,200 | 2,900 | `/api/employee-ops/` |
| `tenants` | تعريف الشركة وعزلها: الأعضاء، الأدوار، الفروع، دفاتر الترقيم، إقلاع شركة جديدة | 3,100 | 2,900 | `/api/tenants/` |
