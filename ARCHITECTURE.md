...
| `crm` | نواةُ CRM كترا التسويقيّة: زبائنُ كترا المحتمَلون (محلّات) قبل أن يصيروا شركاتٍ على المنصّة — مفتاحُهم رقمُ الهاتف المطبَّع، حارسُ ملكيةٍ يمنع عمل موظّفين على عميلٍ واحد، سجلُّ تواصلٍ لا يُحذَف، ونقلٌ رسميٌّ بسببٍ مكتوب. **وحدةٌ داخليّة لموظّفي كترا أنفسِهم لا للشركات** | 1,500 | 1,200 | `/api/platform/crm/` |
