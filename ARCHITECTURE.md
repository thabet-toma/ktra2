...
| `inventory` | المنتجات والمستودعات و`StockMovement` (المصدر الوحيد للرصيد) وطبقات كلفة FIFO (`fifo.py` — والمتوسّط مشتقٌّ منها للعرض) والأرقام التسلسلية وحالة المخزون وحدود التجديد | 8,100 | 7,400 | `/api/inventory/` |
| `hr` | الموظفون والرواتب والحضور الجغرافي والورديات والعقود والطلبات والسلف والخدمة الذاتية | 7,600 | 4,400 | `/api/hr/` |
| `platform_ops` | عمليات المنصة: إسناد موظفي المنصة وإدارة الخدمة واشتراكاتها — **وحدة منصة غير مرخصة للشركات** | 6,600 | 5,600 | `/api/platform/ops/` · `/api/my-agent/` |
