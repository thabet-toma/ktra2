...
| `core` | طبقة مشتركة: عزل الشركة، الصلاحيات، التقارير، الوحدات المرخّصة، الداشبورد، المساعد الذكي | 17,600 | 10,300 | `/api/` (متفرّق) |
| `accounting` | دفتر الأستاذ: شجرة الحسابات، القيود، الشيكات، البنوك، الفترات المالية، العملات، الضريبة | 15,000 | 8,300 | `/api/accounting/` |
| `platform_ops` | عمليات المنصة: فحص صحة دفاتر الشركة المعتمد، وإسناد موظفي المنصة ونقلهم حسب الطاقة، وإدارة الخدمة واشتراكاتها — **وحدة منصة غير مرخصة للشركات** | 13,200 | 11,100 | `/api/platform/ops/` · `/api/my-agent/` |
...
platform_ops ──► core · tenants · sales · partners · inventory
```
