...
| `employee_ops` | متابعة الموظفين: المهامّ والنقاط والتوظيف — **وحدة مرخّصة، معزولة** | 5,700 | 5,200 | `/api/employee-ops/` |
...
| `platform_ops` | عمليات المنصة: إسناد موظفي المنصة وإدارة الخدمة واشتراكاتها — **وحدة منصة غير مرخصة للشركات** | 2,000 | 2,000 | `/api/platform/ops/` |
