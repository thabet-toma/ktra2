-- Logistics & Imports Module Schema (OPTIMIZED)
...
-- OPTIMIZATION: Removed TotalPrice (Calculated field)
...
-- OPTIMIZATION: Direct CoA Linkage & Journal Traceability
CREATE TABLE IF NOT EXISTS `logistics_expenses` (
    ...
    -- Debit Account (The Expense itself) e.g. "Customs Fees"
    `ExpenseAccountID` INT NOT NULL COMMENT 'FK to chartofaccounts (Expense)',
    
    -- Credit Account (The Liability/Payment source) e.g. "Vendor - Customs Broker"
