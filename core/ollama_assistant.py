...
_SYSTEM_PROMPT_BASE = (
    ...
    "- **اعرض دائماً الاسم الكامل (Name_AR كما هو مخزّن)** — فهو يحمل تمييز الصنف "
    ...
    "إلا إذا طلب المستخدم «رقم الصنف/SKU» صراحةً. لا تستخدم SKU للتمييز؛ الاسم الكامل هو المميّز.\n"
