...
# توقيت العمل لا توقيت الخادم. كان 'UTC' والعمل في فلسطين (UTC+2/+3)، فمستند
# يُنشأ بين منتصف الليل والثالثة فجراً كان يُؤرَّخ **بيوم أمس** — خطأ تأريخ
# محاسبي صامت يتكرّر كل ليلة، ولا يظهر إلا حين يسأل مدقّق.
# مع USE_TZ=True التخزين يبقى UTC ولا تتأثر بيانات قائمة؛ ما يتغيّر هو تحويل
# «اليوم» و«الآن» إلى تاريخ العمل — وهو المقصود.
# يُضبط من البيئة لأي نشر خارج فلسطين.
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        # مواصفة #147 (المرحلة 3ب): تسعير المورّد (`DocShareQuoteView`) خانقٌ
