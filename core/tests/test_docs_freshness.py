...
MODULE_DOC_EXEMPTIONS = {
    ...
    # `after_sales` خرجت من الإعفاء بمعلم أمر الصيانة: صارت تكتب في الدفاتر
    # والمخزون، ووحدةٌ تمسّ المال لا تُترك بلا وثيقة — `docs/modules/after_sales.md`.
    ...
    "platform_ops": "وحدة جديدة قيد البناء (المرحلة الأولى: الأساس) — وثيقة الموديول تضاف مع اكتمال المراحل",
}
