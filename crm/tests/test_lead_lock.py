...
OWNERSHIP_EXCUSED = {
    ...
    "/api/platform/crm/colleagues/":
        "دليلُ الزملاء لمنتقي «تحويل إلى» — لا صفَّ عميلٍ فيه إطلاقاً، والمقصودُ منه "
        "أن يرى الموظّفُ زملاءَه. حمولتُه ومَن يظهر فيه مُختبَران في "
        "`test_colleague_directory.py`.",
