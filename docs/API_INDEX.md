...
| `/api/employee-ops/applicants/` | `JobApplicantViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/applicants/{pk}/` | `JobApplicantViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/applicants/{pk}/cv/` | `JobApplicantViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/applicants/{pk}/hire/` | `JobApplicantViewSet` | `employee_ops/views.py` |
...
| `/api/employee-ops/jobs/` | `JobPostingViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/jobs/{pk}/` | `JobPostingViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/jobs/{pk}/close/` | `JobPostingViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/jobs/{pk}/regenerate-token/` | `JobPostingViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/jobs/{pk}/reopen/` | `JobPostingViewSet` | `employee_ops/views.py` |
...
| `/api/employee-ops/public/jobs/<str:token>/` | `PublicJobView` | `employee_ops/views.py` |
| `/api/employee-ops/public/jobs/<str:token>/apply/` | `PublicJobApplyView` | `employee_ops/views.py` |
...
| `/api/employee-ops/tasks/{pk}/start/` | `TaskViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/tasks/{pk}/stop/` | `TaskViewSet` | `employee_ops/views.py` |
| `/api/employee-ops/tasks/{pk}/submit/` | `TaskViewSet` | `employee_ops/views.py` |
...
| `/api/inventory/product-families/` | `ProductFamilyViewSet` | `inventory/views.py` |
| `/api/inventory/product-families/check-name/` | `ProductFamilyViewSet` | `inventory/views.py` |
| `/api/inventory/product-families/{pk}/` | `ProductFamilyViewSet` | `inventory/views.py` |
...
| `/api/logistics/clearances/{pk}/attachments/` | `LogisticsClearanceViewSet` | `logistics/views/clearance.py` |
...
| `/api/logistics/local-shipments/{pk}/attachments/` | `LocalShipmentViewSet` | `logistics/views/transport.py` |
| `/api/logistics/local-shipments/{pk}/attachments/{attachment_id}/` | `LocalShipmentViewSet` | `logistics/views/transport.py` |
...
| `/api/logistics/purchase-invoices/shipment-cost-drift/` | `PurchaseInvoiceViewSet` | `logistics/views/invoices.py` |
...
| `/api/logistics/purchase-rfqs/` | `PurchaseRFQViewSet` | `logistics/views/procurement.py` |
| `/api/logistics/purchase-rfqs/{pk}/` | `PurchaseRFQViewSet` | `logistics/views/procurement.py` |
...
| `/api/logistics/shipments/{pk}/attachments/` | `LogisticsShipmentViewSet` | `logistics/views/shipments.py` |
| `/api/logistics/shipments/{pk}/attachments/{attachment_id}/` | `LogisticsShipmentViewSet` | `logistics/views/shipments.py` |
...
| `/api/logistics/supplier-quotations/{pk}/lines/{line_id}/internal-note/` | `SupplierQuotationViewSet` | `logistics/views/procurement.py` |
...
| `/api/partners/{pk}/surplus/` | `PartnerViewSet` | `partners/views.py` |
...
| `/api/sales/invoices/repeat-last-month/` | `SalesInvoiceViewSet` | `sales/views.py` |
...
| `/api/sales/invoices/{pk}/refund-options/` | `SalesInvoiceViewSet` | `sales/views.py` |
...
| `/api/store/admin/brands/{pk}/` | `StoreBrandAdminViewSet` | `store/views.py` |
| `/api/store/admin/categories/` | `StoreCategoryAdminViewSet` | `store/views.py` |
| `/api/store/admin/categories/{pk}/` | `StoreCategoryAdminViewSet` | `store/views.py` |
...
| `/api/tenants/companies/{pk}/managed-books/` | `TenantViewSet` | `tenants/views.py` |
...
| `/api/tenants/companies/{pk}/set-template/` | `TenantViewSet` | `tenants/views.py` |
