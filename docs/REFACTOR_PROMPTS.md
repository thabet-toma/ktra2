...
**⚠️ يحتاج تحقق دخان على MySQL قبل الاعتماد:** **P2-4** — فرض المفاتيح الأجنبية صار الافتراضي بعد أن كان معطّلاً على كل اتصال إنتاجي طوال عمر النظام. اختبارات المشروع على SQLite لا تكشف قيود FK. مخرج الطوارئ الفوري بلا نشر جديد: `MYSQL_DISABLE_FK_CHECKS=1`.
