...
| `accounting/tests/test_fix_purchase_partner_tags.py` | إصلاح وسم المورد على قيود الشراء القديمة: العرض لا يغيّر، `--apply` يُبقي الذمم وحدها موسومة، الملتبس يُترك، التكرار بلا أثر، و`--tenant` يحصر |
