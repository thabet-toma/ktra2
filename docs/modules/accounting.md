...
def record_reconciliation_adjustment(reconciliation, *, kind, amount, account_id, date=None, description="", exchange_rate=Decimal("1"), user=None):  # A2-3: «قيد تسوية» — سند مصروف/إيراد طرفُه حساب البنك المطابَق، ويُؤشَّر سطره مطابَقاً ذرّياً؛ يرفض المطابقة المُقفلة وتاريخاً بعد الكشف وحساباً مقابلاً من نوعٍ آخر
