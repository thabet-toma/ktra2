...
| `accounting/tests/test_fix_duplicate_deal_journals.py` | قيدُ شراء الصفقة المُرحَّل مرّتين: المتطابقان يبقى أوّلهما، والمختلفان يبقى المطابقُ لإجمالي الصفقة (ولو كان الأقدم)، وما لا يطابق شيئاً أو صفقتُه بعملةٍ أجنبيّة يُترك للمراجعة، والتقرير لا يغيّر والتكرار بلا أثر وفلترُ الشركة يحصر |
