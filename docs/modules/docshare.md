...
**ومصفوفة مقارنة الموردين (ISSUE #116، مواصفة #108 §٨) لا تصل هذا السطح
إطلاقاً** — قرارٌ مقصود لا سهوٌ: `GET /api/logistics/purchase-rfqs/<id>/comparison/`
داخليّةٌ بحتة، وليس لها `doc_type` في `documents.DOC_TYPES` ولا مرشَّحٌ لأن
يكون — الموردُ يرى بنودَه في رابطه الخاص وحده (`purchase_rfq` أعلاه)، لا
عروضَ غيره ولا «أقل سعر» ولا ورقة المقارنة. `docshare/tests/test_purchase_rfq_comparison_not_shareable.py`
يحرس القرار نفسه: يسمّي مرشَّح المفتاح ويثبت غيابه من السجلّ، لا مجرّد أن
سلسلةً عشوائية تُرفَض.
...
## الاختبارات
`docshare/tests/` — التسريب (المرجع الأهمّ)، ودورة الحياة (‏410 للمنتهي والمُبطَل، إعادة استعمال الحيّ، الزاحف لا يُحتسب)، والقرار (‏FSM · مرة واحدة · بلا اسم · على مستند لا يقبله)، وسطح الإدارة (‏الصلاحية · عزل الشركة · 404 لا 403). و`test_purchase_rfq_comparison_not_shareable.py` (ISSUE #116) — حارسُ قرارٍ لا سلوك: ورقة مقارنة الموردين بلا `doc_type` في السجلّ، ومحاولة مشاركتها عبر سطح الإدارة ترتدّ 400.
