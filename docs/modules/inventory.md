...
- **والعكس: حذفُ وارِدٍ سبق FIFO يقصّ الافتتاحيّة** (`fifo.trim_opening_layers`): بضاعتُه
  ...
  معه فيبقى الفرقُ = المستهلَك. والكلفةُ كلفةُ الطبقة: قيمةُ الوارد ذابت في متوسّطها.
...
| `inventory/tests/test_reversal_opening_layer_trim.py` | حذفُ وارِدٍ سبق FIFO: الافتتاحيّةُ تُقصّ حتى تطابق الطبقاتُ الرصيد، لا يُمسّ غيرُ الافتتاحيّ ولا ما استُهلك منها، والوارِدُ ذو الطبقة لا يُقصّ له شيء |
