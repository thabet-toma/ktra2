...
| `frontend_v2/components/platform-hiring/` | شاشة التوظيف المنصي وتبويباتها (الوظائف، المتقدمون، مسؤولو التوظيف، **واجتماعات المتقدّمين** — ولوحة تفاصيل المتقدم) وصفحتا التقديم العام وقبول الدعوة |
