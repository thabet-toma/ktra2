...
const RevenueVouchersPage = lazyPage(() => import("./components/accounting/RevenueVouchersPage").then((m) => ({ default: m.RevenueVouchersPage })));
...
const VIEW_PATHS: Partial<Record<AppView, string>> = {
  ...
  "accounting-revenue-vouchers": "/accounting/revenue-vouchers",
...
const App: React.FC = () => {
  ...
  const renderMainContent = () => {
    ...
    switch (appView) {
      ...
      // #207 م٦ — «مركز قيادة شؤون الموظفين والمهام» (كان «مركز قيادة كترا»). **والتركيبُ جزءٌ من التسليم لا زينةٌ بعده**:
