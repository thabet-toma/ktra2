...
const HISTORY_KEY = "ktra_calc_history";
...
interface KitCalculatorPopoverProps {
...
export const KitCalculatorPopover: React.FC<KitCalculatorPopoverProps> = ({
  initialValue,
  x,
  y,
  onConfirm,
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs font-extrabold bg-gradient-to-l from-emerald-400 to-indigo-400 bg-clip-text text-transparent tracking-wider">الحاسبة</span>
      ...
      <div className="relative bg-slate-950/80 rounded-3xl px-4 py-3 mb-4 border border-slate-800/80 shadow-inner min-h-[80px] flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative flex justify-between items-center">
          <span className="text-slate-500 text-[10px] tracking-[.2em] font-semibold uppercase">K.T.R.A</span>
