...
export const InstallmentManager: React.FC<InstallmentManagerProps> = ({
    ...
    return (
        ...
        >
                            ...
                            <span
                                className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${
                                    planActive
                                        ...
                                        : 'bg-gray-100 text-gray-500 dark:bg-gray-600/50'
                                }`}
                            >
                                {isShipmentFinance
                                    ? planActive
            ...
            {/* --- Body --- */}
            {!planActive ? (
                <div className="text-center py-8 px-4 text-gray-500 text-sm rounded-xl bg-gray-50/80 dark:bg-gray-800/50 border border-dashed border-gray-200 dark:border-gray-700">
                    {isShipmentFinance ? (
                        <>
                            <p className="font-medium text-gray-700 dark:text-gray-300 mb-1">لا يوجد إجمالي شحنة بعد</p>
