...
export const DealInfoSection: React.FC<DealInfoSectionProps> = ({
  ...
  return (
    <div className="border ktra-border-accent dark:ktra-border-soft rounded-xl overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r ktra-bg-panel ktra-bg-panel dark:ktra-bg-panel dark:ktra-bg-panel px-6 py-4 border-b ktra-border-accent dark:ktra-border-soft">
        <h3 className="text-lg font-semibold ktra-text-ink dark:ktra-text-soft flex items-center gap-2">
          <Factory className="w-5 h-5" />
          معلومات الصفقة المرتبطة
          {formData.dealNumber && (
            <span className="text-sm ktra-bg-accent-bg ktra-text-ink dark:ktra-bg-panel dark:ktra-text-soft px-2 py-1 rounded">
              {formData.dealNumber}
            </span>
          )}
        </h3>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium ktra-text-ink dark:ktra-text-soft flex items-center gap-2">
            ...
            <select
              ...
              className="w-full p-2 border ktra-border-soft dark:ktra-border-soft rounded-lg ktra-bg-field dark:ktra-bg-panel ktra-text-ink dark:text-white"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Production Timeline */}
          <div className="space-y-4 p-4 ktra-bg-panel dark:ktra-bg-panel/30 rounded-lg border">
            <h4 className="font-medium ktra-text-ink dark:ktra-text-soft flex items-center gap-2">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-sm ktra-text-soft dark:ktra-text-soft">أيام الإنتاج</label>
                  <input
                    type="number"
                    value={dealInfo.productionDays || ''}
                    onChange={(e) => onUpdateDealInfo('productionDays', parseInt(e.target.value) || 0)}
                    className="w-full p-2 border rounded-lg dark:ktra-bg-panel dark:ktra-border-soft dark:text-white"
                  />
                </div>
                <div>
                  <label className="text-sm ktra-text-soft dark:ktra-text-soft">أيام التسليم</label>
                  <input
                    type="number"
              ...
              {dealInfo.startedProductionAt && (
                <div className="text-sm">
                  <span className="ktra-text-soft dark:ktra-text-soft">بدء الإنتاج: </span>
          ...
          <div className="space-y-4 p-4 ktra-bg-panel dark:ktra-bg-panel/30 rounded-lg border">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-sm ktra-text-soft dark:ktra-text-soft">تاريخ الدفعة الأولى</label>
                <input
                  type="date"
              ...
              {dealInfo.completedAt && (
                <div className="text-sm">
                  <span className="ktra-text-soft dark:ktra-text-soft">تاريخ الإكمال: </span>
        ...
        <div className="space-y-2">
          ...
          {dealInfo.alibabaOrderLink && (
            <p className="text-xs ktra-text-accent dark:ktra-text-soft">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={4}
            className="w-full p-3 border ktra-border-soft dark:ktra-border-soft rounded-lg ktra-bg-field dark:ktra-bg-panel ktra-text-ink dark:text-white"
