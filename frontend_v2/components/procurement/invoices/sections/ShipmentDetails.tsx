  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-medium aseel-text-ink dark:aseel-text-soft flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="0.00"
              />
              <span className="aseel-text-soft text-sm">kg</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="0.000"
              />
              <span className="aseel-text-soft text-sm">m³</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={6}
            className="w-full p-3 border rounded-lg dark:aseel-bg-panel dark:aseel-border-soft dark:text-white"
      ...
      {(formData.totalWeight || formData.totalVolume) && (
        <div className="mt-6 p-4 aseel-bg-panel dark:aseel-bg-panel/30 rounded-lg border">
          <h4 className="font-medium aseel-text-ink dark:aseel-text-soft mb-3">ملخص الشحن</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {formData.totalWeight && (
              <div className="flex items-center justify-between">
                <span className="text-sm aseel-text-soft dark:aseel-text-soft">الوزن الكلي:</span>
                <span className="font-medium">{formData.totalWeight.toLocaleString()} كجم</span>
              </div>
            )}
            {formData.totalVolume && (
              <div className="flex items-center justify-between">
                <span className="text-sm aseel-text-soft dark:aseel-text-soft">الحجم الكلي:</span>
