...
export const ShipmentList: React.FC<ShipmentListProps> = ({ shipments, onEdit, onView, onDelete, shippingAgents }) => {
    ...
    const getStatusStyle = (status: Shipment['status']) => {
        ...
        switch (status) {
            case 'draft': return `${baseClass} ktra-bg-panel ktra-text-soft ktra-border-soft dark:ktra-bg-panel dark:ktra-text-soft dark:ktra-border-soft`;
            case 'payment_pending': return `${baseClass} ktra-bg-panel ktra-text-ink ktra-border-soft dark:ktra-bg-panel/20 dark:ktra-text-soft dark:ktra-border-soft`;
            case 'partially_paid': return `${baseClass} ktra-bg-accent-bg ktra-text-accent ktra-border-accent dark:ktra-bg-panel/20 dark:ktra-text-soft dark:ktra-border-soft`;
            case 'paid': return `${baseClass} bg-green-50 text-green-700 ktra-border-soft dark:bg-green-900/20 dark:text-green-300 dark:border-green-800`;
            ...
            case 'cancelled': return `${baseClass} ktra-bg-panel ktra-text-state ktra-border-soft dark:ktra-bg-panel/20 dark:ktra-text-soft dark:ktra-border-soft`;
            default: return `${baseClass} ktra-bg-panel ktra-text-soft`;
        }
    };
    ...
    if (shipments.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-24 ktra-bg-panel/50 dark:ktra-bg-panel/50 rounded-3xl border-2 border-dashed ktra-border-soft dark:ktra-border-soft">
                <div className="p-4 ktra-bg-field dark:ktra-bg-panel rounded-full shadow-sm mb-4">
                    <Truck className="w-12 h-12 ktra-text-soft/50" />
                </div>
                <h3 className="text-xl font-bold ktra-text-ink dark:text-white">لا توجد شحنات حالياً</h3>
                <p className="ktra-text-soft dark:ktra-text-soft mt-2 max-w-sm text-center">
        ...
        <>
            <div className="overflow-x-auto pb-4">
                <table className="w-full text-right">
                    <thead>
                        <tr className="ktra-text-soft dark:ktra-text-soft text-[10px] font-semibold uppercase tracking-wider border-b ktra-border-soft dark:ktra-border-soft">
                    ...
                    <tbody className="text-xs">
                        {shipments.map((shipment) => {
                            ...
                            return (
                                <tr
                                    key={shipment.id}
                                    className="ktra-bg-field dark:ktra-bg-panel border-b ktra-border-soft dark:ktra-border-soft/50 hover:ktra-bg-panel dark:hover:ktra-bg-panel/50 transition-all duration-150"
                                >
                                    {/* اسم الشحنة */}
                                    <td className="px-3 py-3">
                                        <div className="flex items-start gap-3">
                                            <div className={`p-2 rounded-lg mt-1 ${shippingType === 'sea' ? 'ktra-bg-accent-bg dark:ktra-bg-panel/20 ktra-text-accent dark:ktra-text-soft' : 'bg-[var(--color-surface-2)] dark:bg-[var(--color-surface-2)]/20 text-[var(--color-primary)] dark:text-[var(--color-primary)]'}`}>
                                                {shippingType === 'sea' ?
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="font-bold ktra-text-ink dark:text-white mb-1 flex items-center gap-2">
                                                    <Truck className="w-3 h-3 ktra-text-soft flex-shrink-0" />
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {/* رقم الشحنة */}
                                                    <div className="flex items-center gap-1 text-[10px] ktra-text-soft ktra-bg-panel dark:ktra-bg-panel px-2 py-0.5 rounded">
                                    ...
                                    <td className="px-2 py-3">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-1">
                                                <Calendar className="w-3 h-3 ktra-text-soft flex-shrink-0" />
                                                <span className="text-[11px] ktra-text-soft dark:ktra-text-soft" title="تاريخ الإنشاء">
                                            ...
                                            {departureDate && (
                                                <div className="flex items-center gap-1">
                                                    <TrendingUp className="w-3 h-3 ktra-text-soft flex-shrink-0" />
                                                    <span className="text-[11px] ktra-text-soft dark:ktra-text-soft" title="تاريخ المغادرة">
                                            ...
                                            {arrivalDate && (
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-[11px] ktra-text-soft dark:ktra-text-soft" title="تاريخ الوصول المتوقع">
                                    ...
                                    <td className="px-2 py-3">
                                        <button
                                            ...
                                            className="group/agent flex items-center gap-1 px-2 py-1.5 rounded-lg hover:ktra-bg-panel dark:hover:ktra-bg-panel/70 transition-colors w-full text-right"
                                            title={shipment.shippingAgentName}
                                        >
                                            <div className="flex-1 min-w-0">
                                                <div className="text-xs ktra-text-ink dark:ktra-text-soft truncate group-hover/agent:ktra-text-accent dark:group-hover/agent:ktra-text-soft transition-colors">
                                                    {shipment.shippingAgentName}
                                                </div>
                                                <div className="text-[10px] ktra-text-soft truncate">
                                                    وكيل شحن
                                                </div>
                                            </div>
                                            <div className="w-1.5 h-1.5 rounded-full ktra-bg-panel flex-shrink-0" />
                                        </button>
                                    </td>
                                    ...
                                    <td className="px-2 py-3">
                                        <div className="flex flex-col gap-1 items-center">
                                            <div className="flex items-center gap-1" title="الحجم">
                                                <Box className="w-3 h-3 ktra-text-soft" />
                                                <span className="font-mono font-bold text-sm ktra-text-ink dark:ktra-text-soft">
                                                ...
                                                <span className="text-[10px] ktra-text-soft">م³</span>
                                            </div>
                                            <div className="flex items-center gap-1" title="الوزن">
                                                ...
                                                <span className="text-[10px] ktra-text-soft">كجم</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-2 py-3">
                                        <div className="flex items-center gap-0.5 justify-end">
                                            ...
                                            <span className="font-bold text-lg ktra-text-ink dark:text-white">
                                        ...
                                        {shipment.installmentPlanEnabled && shipment.installments && shipment.installments.length > 0 && (
                                            <div className="text-[10px] ktra-text-soft text-right mt-0.5">
                                    ...
                                    <td className="px-2 py-3">
                                        <div className="flex items-center gap-2">
                                            <div className={`p-1.5 rounded-lg ${shippingType === 'sea' ? 'ktra-bg-accent-bg dark:ktra-bg-panel/20' : 'bg-[var(--color-surface-2)] dark:bg-[var(--color-surface-2)]/20'}`}>
                                                {getShipmentStatusIcon(shipment)}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <div className="text-xs font-medium ktra-text-ink dark:ktra-text-soft truncate">
                                    ...
                                    <td className="px-3 py-3 text-left">
                                        <div className="flex items-center gap-1">
                                            ...
                                            {shippingType === 'sea' ? (
                                                (shipment.shippingInfo?.trackingLink ||
                                                    ...
                                                    <a
                                                        ...
                                                        className="p-2 ktra-text-soft hover:ktra-text-ink ktra-bg-panel hover:ktra-bg-panel dark:ktra-bg-panel/20 dark:ktra-text-soft dark:hover:ktra-bg-panel/40 rounded-lg transition-colors"
                                                        title="تتبع الشحنة"
                                                    >
                                            ...
                                            <button
                                                ...
                                                className="p-2 ktra-text-accent hover:ktra-text-accent ktra-bg-accent-bg hover:ktra-bg-accent-bg dark:ktra-bg-panel/20 dark:ktra-text-soft dark:hover:ktra-bg-panel/40 rounded-lg transition-colors"
                                                title="تعديل الشحنة"
                                            >
