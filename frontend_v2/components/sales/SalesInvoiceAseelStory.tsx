/**
 * M1 verification harness — mounts the REAL <SalesInvoiceEditor> (Aseel shell)
 * with representative mock props so the screen can be eyeballed live without a
 * backend session. NOT a production screen — dev/QA only, mirrors AseelKitStory.
...
export const SalesInvoiceAseelStory: React.FC = () => (
