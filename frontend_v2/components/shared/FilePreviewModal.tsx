...
export const FilePreviewModal: React.FC<{
  ...
  return (
    ...
    >
      <div className="flex h-[88vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl">
        <div className="flex items-center justify-between gap-3 border-b border-[var(--color-border)] p-3">
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            <button type="button" className="aseel-toolbtn" onClick={onClose} title="إغلاق">
              <X className="h-4 w-4" />
            </button>
          </div>
        </div>

        <div className="flex flex-1 items-center justify-center overflow-auto bg-[var(--color-surface-2)] p-2">
          {isImage(file) ? (
