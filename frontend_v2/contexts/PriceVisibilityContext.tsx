...
/**
 * إظهار/إخفاء أسعار الأصناف (آخر/أقل سعر) في قوائم الاختيار **والربح الإجمالي** في محرّر
 * الفاتورة — تفضيل عام للخصوصية: حين يكون زبون أمام الشاشة لا يرى الأسعار ولا الأرباح.
 * مصدر حقيقة واحد يستهلكه AseelAutocomplete وزر العين ومحرّر فاتورة المبيعات وصفحة الإعدادات.
 *
