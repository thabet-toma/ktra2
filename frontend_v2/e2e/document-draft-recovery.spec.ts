...
const BATCH4_SCREENS: Array<{
  ...
  { name: 'إشعار دائن/مدين', route: '/accounting/credit-debit-notes', permissions: ['accounting.journal.view', 'accounting.journal.create'],
    touch: '[data-testid="note-reason"]', value: 'NOTE-DRAFT-001' , newLabel: 'إشعار جديد' , reopensItself: true },
