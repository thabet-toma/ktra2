/**
 * T-REORDER: حالة الصنف داخل مستندات البيع — شارةٌ واحدة وبدائلُ نوعٍ واحد.
 *
 * لماذا هنا لا في كل شاشة: منتقي الصنف يظهر في فاتورة البيع وعرض السعر وطلبية
 ...
 *
 * والبديل: أصناف **نفس النوع** (`group_key` الخادمي) التي عليها رصيد. هذا هو
...
/**
 * شارة الصنف في القائمة. الخدمة بلا مخزون فبلا شارة — «نفذ» على بند خدمة
...
/** هل يستحق هذا الصنف اقتراح بديل — أي أن بيعه متعثّر الآن. */
...
/**
 * بدائل الصنف: موديلات نفس النوع التي عليها رصيد متاح، الأوفر أولاً.
 * صنفٌ بلا `group_key` بلا بدائل — لا نخمّن التبادل من تشابه الاسم.
 */
