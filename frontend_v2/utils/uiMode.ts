...
export const SIMPLE_MASK = {
  ...
  // issue #80 — سند الإيراد: مرآةُ ما فوقه. الدافع اختياريٌّ كالمستفيد، ومن
  // يسجّل «قبضت 50 عمولة» لا يحتاج أن يسمّي من دفعها.
  'doc.revenue-payer':
    'الدافع في سند الإيراد (شريك أو اسم حر) — إيرادٌ نقديٌّ بسيط لا يحتاج تسمية دافعه.',
} as const;
