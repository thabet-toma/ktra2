...
#: صفقة الاستيراد بالدولار دائماً (قرار المالك 2026-09-24) — لا حقل عملة على الصفقة
#: (أُزيل في الهجرة 0092): العرضُ من هنا، والترحيلُ من سعر كل دفعة (`payment_posting.py`).
...
class PurchaseSettings(models.Model):
    ...
    # ISSUE #117: أمر الشراء خطوة اختيارية في سلسلة الشراء المحلي — مطفأً
    # (الافتراضي): السلسلة تصير طلبية ← عروض ← فاتورة بلا أمر شراء. المفتاح
    # يحكم **الإنشاء لا الرؤية**: أمرُ شراءٍ قائم يبقى مرئياً ومفتوحاً للاطّلاع
    # حتى بعد الإطفاء — وإلّا تُتِّمنا فواتيرَ تنسب نفسها إلى أمرٍ لا يُفتح.
    # `GoodsReceipt.invoice` مربوطٌ بالفاتورة لا بأمر الشراء فلا يقطع الاستلام،
    # ولا قيدَ محاسبياً لأمر الشراء فلا أثر في الدفاتر (#117).
    use_purchase_orders = models.BooleanField(
        default=False,
        db_column="UsePurchaseOrders",
        help_text="تفعيل خطوة «أمر الشراء» بين عرض السعر والفاتورة في سلسلة الشراء المحلي",
    )
