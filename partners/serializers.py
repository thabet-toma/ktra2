...
# `suggest_partner_matches` انتقلت إلى `partners/services.py` (بحثُ مطابقةٍ لا
# مُسلسِل)، وتُعاد هنا للتوافق مع مستدعيها القائمين.
from .services import normalize_identifier, suggest_partner_matches  # noqa: F401
...
# والتطبيع نفسه (`normalize_identifier`) يسكن `partners/services.py`.
