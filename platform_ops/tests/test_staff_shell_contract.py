...
REUSED_STAFF_PANELS = (
    ...
    "MyProfileCard.tsx",
    "MyMeetingsPanel.tsx",
    # ‏#214-ج: «الراتب الذي يُصرف لك» — سابعةُ اللوحات المُعادِ استعمالُها،
    # يركّبها `StaffShell` في تبويب الملفّ. أُضيفت هنا يومَ رُكِّبت لا بعدَه:
    # القائمةُ مكتوبةٌ باليد، فلوحةٌ غائبةٌ عنها لا تُمسَح ويبقى الحارسُ أخضرَ
    # فوق رقعةٍ بيضاءَ في شاشةٍ داكنة.
    "EmployeePayTermsCard.tsx",
