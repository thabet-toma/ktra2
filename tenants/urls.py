...
from .views import BookHandoverRequestViewSet, BranchViewSet, CurrencyViewSet, TenantBookViewSet, TenantSettingsViewSet, TenantViewSet
...
router.register(r"handover-requests", BookHandoverRequestViewSet, basename="tenant-handover-requests")
